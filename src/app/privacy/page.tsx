    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <main className="max-w-4xl mx-auto px-4 py-32 relative z-10">
                <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-8 tracking-tight">개인정보처리방침</h1>
                ...
                <div className="bg-card/50 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 p-8 space-y-8">
                    <section>
                        ...
                        <ul className="list-disc list-inside text-muted-foreground space-y-2 marker:text-primary">
                            ...
                            <li><strong className="text-white">선택 항목:</strong> 프로필 사진, 닉네임, 관심 업종/지역</li>
                            <li><strong className="text-white">자동 수집:</strong> 서비스 이용 기록, 접속 로그, 앱 사용 통계</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-4 marker:text-primary">
                        ...
                        <div className="mt-4 border border-white/10 rounded-lg overflow-hidden">
                            <table className="w-full text-sm">
                                <thead className="bg-white/5">
                                    <tr>
                                        <th className="px-4 py-3 text-left text-white font-semibold">수탁업체</th>
                                        <th className="px-4 py-3 text-left text-white font-semibold">위탁업무</th>
                                    </tr>
                                </thead>
                                <tbody className="text-muted-foreground">
                                    <tr className="border-t border-white/5">
                                        <td className="px-4 py-3">Supabase</td>
                                        <td className="px-4 py-3">데이터베이스 호스팅, 인증 서비스</td>
                                    </tr>
                                    <tr className="border-t border-white/5">
                                        <td className="px-4 py-3">Firebase (Google)</td>
                                        <td className="px-4 py-3">푸시 알림 서비스</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mt-4">
                            위 권리 행사는 앱 내 설정 또는 고객센터(<a href="mailto:support@playbid.kr" className="text-primary hover:text-blue-400 font-medium">support@playbid.kr</a>)를 통해 가능합니다.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground space-y-1">
                            ...
                            <li>이메일: <a href="mailto:privacy@playbid.kr" className="text-primary hover:text-blue-400 font-medium">privacy@playbid.kr</a></li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">8. 개인정보 처리방침 변경</h2>
                        <p className="text-muted-foreground leading-relaxed">
