...
5. 운영 배포 체계 정리: Coolify Git 배포 트리거는 복구됐으나 원격 Git 소스가 운영 최신과 불일치. `red2red/playbid_vultr` 소스 동기화 + 재배포 리허설(로그인/콜백 스모크 포함) 완료 후 Git 경로를 운영 기본으로 전환
